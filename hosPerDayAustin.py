...
hosPerDayAustin = True 


# Plot the cumulative tests for HAYES COUNTY 
if hosPerDayAustin == True :
    # -------------------------------------------------------------------------------------------------
    ...
    with open('data/Austin/dateshosp.txt', 'r') as file:
    ...
    # -------------------------------------------------------------------------------------------------
    cases = np.loadtxt('data/Austin/hosperday.txt')
    ...
    plt.ylabel("Hospitlizations per Day (people)")
    plt.title("New Hospitlizations Over Time Per Day in Austin")
    plt.show()